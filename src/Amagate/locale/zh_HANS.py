{
    ...
    ("*","The Gorge of Orlok"): "奥罗峡谷",
    ("*","Fortress of Nemrut"): "内姆鲁特要塞",
    ("*","The Oasis of Nejeb"): "内杰布绿洲",
    ("*","Temple of Al Farum"): "阿尔法鲁神庙",
    ("*","Forge of Xshathra"): "克沙斯拉铸造厂",
    ("*","The Temple of Ianna"): "伊安娜神殿",
    ("*","Tower of Dal Gurak"): "达古拉塔楼",
    ("*","The Abyss"): "深渊",
    ...
    ("Operator", "To Sector"): "转换为扇区",
    ("Operator", "Convert to Ghost Sector"): "转换为虚拟扇区",
    ("Operator", "To Ghost Sector"): "转换为虚拟扇区",
    ("*", "Convert selected objects to sector"): "将所选物体转换为扇区",
    ("*", "Convert selected objects to ghost sector"): "将所选物体转换为虚拟扇区",
    ...
    ("*", "Select at least two non-2d-sphere sectors"): "至少选择两个非二维球面扇区",
    ...
    ("*", "Export Map (with Run Script)"): "导出地图 (带运行脚本)",
    ("*", "Export Map"): "导出地图",
