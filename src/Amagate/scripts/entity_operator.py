...
class OT_ExportEntity(bpy.types.Operator):
    ...
    def execute(self, context: Context):
        ...
        buffer = StringIO()
        buffer.write("# Automatically generated by Amagate\n\n")
        buffer.write("import Bladex\n")
        buffer.write("import ItemTypes\n")
        buffer.write("import EnemyTypes\n")
        buffer.write("import Reference\n")
        buffer.write("import darfuncs\n")
        buffer.write("import AuxFuncs\n")
        buffer.write("import Actions\n")
        buffer.write("import CharStats\n")
        buffer.write("import Torchs\n")
        buffer.write("import Breakings\n\n")
        #
        ...
        with open(map_dir / "AG_Objs.py", "w", encoding="utf-8") as file:
